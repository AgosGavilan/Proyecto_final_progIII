    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Panel de Administración')" class="grid">
                ...
                <flux:navlist.item icon="shopping-bag" :href="route('productos.index')"
                    :current="request()->routeIs('productos.index')" wire:navigate>{{ __('Productos') }}
                </flux:navlist.item>
                <flux:navlist.item icon="clipboard" :href="route('pedidos.index')" :current="request()->routeIs('pedidos.index')" wire:navigate>{{ __('Pedidos') }}</flux:navlist.item>
            </flux:navlist.group>
        </flux:navlist>
